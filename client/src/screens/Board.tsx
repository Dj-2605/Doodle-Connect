...
import pen from "../assert/pen.svg";
...
const Board: React.FC<MyBoard> = (props) => {
    ...
    const cursorStyle = {
        ...
        cursor: `url(${pen}), auto` // Replace 'path_to_your_cursor_image.png' with the actual path to your cursor image
      };

    useEffect(() => {

        const newSocket = io(json.ip+':4000');
